...
- **Point trend dashboard**: telemetry trends are always shown in a dedicated section, and operators can add multiple selected Point nodes to compare their lines with legend labels.
